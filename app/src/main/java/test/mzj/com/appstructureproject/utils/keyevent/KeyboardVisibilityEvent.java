...
import test.mzj.com.appstructureproject.utils.CommonUtils;
...
public class KeyboardVisibilityEvent {
        ...
        activityRoot.getViewTreeObserver().addOnGlobalLayoutListener(
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    private final int visibleThreshold =
                            Math.round(CommonUtils.dip2px(activity, KEYBOARD_VISIBLE_THRESHOLD_DP));
    ...
    public static boolean isKeyboardVisible(Activity activity) {
        ...
        int visibleThreshold = Math.round(CommonUtils.dip2px(activity, KEYBOARD_VISIBLE_THRESHOLD_DP));
        activityRoot.getWindowVisibleDisplayFrame(r);
        int heightDiff = activityRoot.getRootView().getHeight() - r.height();
