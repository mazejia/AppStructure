...
public class QTabView extends TabView {
    ...
    private void initTitleView() {
        ...
        mTitle.setTextSize(mTabTitle.mTextSizeNormal);
...
//        mTitle.setPadding(dp2px(5), dp2px(5), dp2px(5), dp2px(5));
    ...
    public void setChecked(boolean checked) {
        ...
        if (mChecked) {
            ...
            mTitle.setTextSize(mTabTitle.mTextSizeSelected);
    ...
    public static class TabTitle {
        ...
        private TabTitle(int mColorSelected, int mColorNormal, int mTextSizeSelected,int mTextSizeNormal, String mContent) {
        ...
        public static class Builder {
            ...
            public Builder setTextSize(int sizeSelected,int sizeNormal) {
                mTextSizeSelected = sizeSelected;
                mTextSizeNormal = sizeNormal;
                return this;
            }
            ...
            public TabTitle build() {
                return new TabTitle(mColorSelected, mColorNormal, mTextSizeSelected, mTextSizeNormal, mContent);
            }
        }
    }
}